...
def get_channel_info(channel_id):
    ...
    for i in range(0,len(response1["items"])):
        data = dict(
                    ...
                    Subscription_Count= response1["items"][i]["statistics"]
                                                ["subscriberCount"],
                    Views = response1["items"][i]["statistics"]["viewCount"],
                    Total_Videos = response1["items"][i]["statistics"]
                                            ["videoCount"],
                    Channel_Description = response1["items"][i]["snippet"]["description"],
                    Playlist_Id = response1["items"][i]["contentDetails"]
            ...
            for video_id in video_ids:
                    ...
                    for item in response5["items"]:
                            comment_information = dict(
                                    ...
                                    Comment_Author = item["snippet"]
                                    ["topLevelComment"]["snippet"]["authorDisplayName"],
                                    Comment_Published = item["snippet"]
        ...
        if st.button("Collect and Store data"):
            for channel in channels:
                ...
                if channel in ch_ids:
                    st.success("Channel details of the given channel id: " +channel+
                                " already exist")
                else:
